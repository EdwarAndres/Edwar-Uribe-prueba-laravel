<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('codigo_temporal') }}
            {{ Form::text('codigo_temporal', $user->codigo_temporal, ['class' => 'form-control' . ($errors->has('codigo_temporal') ? ' is-invalid' : ''), 'placeholder' => 'Codigo Temporal']) }}
            {!! $errors->first('codigo_temporal', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('correo') }}
